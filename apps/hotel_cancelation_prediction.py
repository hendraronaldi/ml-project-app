...
class HotelCancelation:
	...
	def input_features(self):
		...
		return pd.DataFrame({
			...
			'total_of_special_requests': [st.number_input('total_of_special_requests', min_value=0, max_value=5, step=1)],
			...
			'previous_bookings_not_canceled': [st.number_input('previous_bookings_not_canceled', min_value=0, max_value=75, step=1)],
			'previous_cancellations': [st.number_input('previous_cancellations', min_value=0, max_value=30, step=1)],
			'required_car_parking_spaces': [st.number_input('required_car_parking_spaces', min_value=0, max_value=10, step=1)],
